...
\subsection{Legislator Relations}
...
\begin{description}
    ...
    \item[Weak dependence on shared time] Two legislators should not receive an insurmountably high relations score purely by virtue of having a long time in office together. However, it does make since for there to be some dependence on shared experience, but should not be a linera relationship.
    \item[Linearity] If we have legislators $a$ and $b$, who cosponsor twice as much lesgislation with each other as legislators $c$ and $d$, then the relationship between $a$ and $b$ should be considered twice as strong.
\end{description}
