...
\usepackage[style=numeric, hyperref=true, backref=true]{biblatex}
\usepackage{setspace}
\onehalfspacing
...
The literature on bill cosponsorship is relatively sparse, but there is some literature that I use to inform th
